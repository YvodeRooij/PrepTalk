 ...
 * A comprehensive design system combining minimalist philosophies from
 * Google (simplicity), Apple (elegance), Vercel (performance), and OpenAI (approachability)
 */
...
export const designSystem = {
  ...
  colors: {
    ...
    // Success - Interview Success Green
    success: {
      50: '#F0FDF4',
      100: '#DCFCE7',
      200: '#BBF7D0',
...
export type ColorScheme = typeof designSystem.colors
